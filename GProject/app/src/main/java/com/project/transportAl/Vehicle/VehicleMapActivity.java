...
/**
 * This class will do the vehicle map, trip history, draw line on the map, log out function, customer rating
 */
public class VehicleMapActivity extends AppCompatActivity
    ...
    /**
     * Initializing all the button and method
    ...
    /**
     * This method will work for the screnn layout up and down
     */
    View mBottomSheet;
    ...
    /**
     * This method will get the client data from the firebase database.
     */
    ...
    /**
     * This method driver/vehicle will receive the specific customer who requested for the ride
     */
    ...
    /**
     * THis method will work from where to collect the client
     */
    Marker pickupMarker;
    ...
    /**
     * This method will work for the draw a line between two points on the map
     * @param pickupLatLng
     */
    ...
    /**
     * This method will work when client set the destination for pick up.
     */
    ...
    /**
     * This method will get info from the customer for the driver/vehicle
     */
    ...
    /**
     * This method will do functionality of when driver/vehicle will picked client from customer request.
     */
    ...
    /**
     * This method will keep track record all the details of the trip history
     */
    ...
    /**
     * This method will ask for permission for the map
     */
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(VehicleMapActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
    ...
    /**
     * This method will ask for permission from the user to get access to the map in side the device
     * @param requestCode
     * @param permissions
     * @param grantResults
     */
    ...
    /**
     * This method will connect vehicle with location in the map
     */
    ...
    /**
     * This method will disconnect the vehicle from the map/location
     */
    ...
    /**
     * This method will create the line between the two points - driver and client
     */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.history) {
            Intent intent = new Intent(VehicleMapActivity.this, HistoryActivity.class);
            intent.putExtra("customerOrDriver", "Drivers");
            startActivity(intent);
        } else if (id == R.id.settings) {
            Intent intent = new Intent(VehicleMapActivity.this, VehicleSettingsActivity.class);
            startActivity(intent);
