...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    /**
     * This method will get the trip details
     */
    ...
    /**
     * This method will implement the payment with PayPal
     */
    private void payPalPayment() {
        PayPalPayment payment = new PayPalPayment(new BigDecimal(ridePrice), "USD", "MyTaxi Ride",
    ...
    /**
     * This method will send the user details as a notification and will appear on the phone screen
    ...
    /**
     * This method will mark the rote in the map
     */
   ...
   // private static final int[] COLORS = new int[]{R.color.primary_dark_material_light};
    public static final int[] COLORS = new int[]{R.color.colorPrimary};
    @Override
